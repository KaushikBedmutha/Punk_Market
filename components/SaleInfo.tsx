    ...
    <Tabs>
      ...
      <TabPanels>
        <TabPanel>
          <Stack spacing={8}>
            <Box>
              <Text color={'gray.700'}>Listing starts on:</Text>
              <Input
                color={'gray.700'}
                mt={2}
        ...
        <TabPanel>
          <Stack spacing={8}>
            ...
            <Box>
              ...
              <Input placeholder="0" size="md" type="number" {...registerAuction('floorPrice')} />
            </Box>
            <Box>
              <Text fontWeight={'bold'}>Buyout price:</Text>
              <Input placeholder="0" size="md" type="number" {...registerAuction('buyoutPrice')} />
            </Box>
            <Web3Button
              contractAddress={MARKETPLACE_ADDRESS}
              action={async () => {
